...
#     trainset = ImageNet(root='../cross-domain-fsl/dataset/imagenet/train')
#     train_sampler = CategoriesSampler(trainset.label, 100,
#                                       args.train_way, args.shot + args.query)
#     train_loader = DataLoader(dataset=trainset, batch_sampler=train_sampler,
#                               num_workers=8, pin_memory=True)

#     valset = ImageNet(root='../cross-domain-fsl/dataset/imagenet/test')
...
if __name__ == '__main__':
    ...
    trainset = MiniImageNet(root='../cross-domain-fsl/dataset/tiered-imagenet/train')
    train_sampler = CategoriesSampler(trainset.label, 100,
                                      args.train_way, args.shot + args.query)
    train_loader = DataLoader(dataset=trainset, batch_sampler=train_sampler,
                              num_workers=8, pin_memory=True)
    ...
    valset = MiniImageNet(root='../cross-domain-fsl/dataset/tiered-imagenet/val')
