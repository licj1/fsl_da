...
from CDAN_pytorch.dropblock import DropBlock
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, keep_prob=1.0, avg_pool=False, drop_rate=0.0, dropblock_size=5, classes=20):
        self.inplanes = 3
        ...
        self.cls = nn.Linear(640, classes)
